...
COPY . /go/src/github.com/roock/bareos_exporter
WORKDIR /go/src/github.com/roock/bareos_exporter
RUN go get -v .
...
COPY --from=builder /go/src/github.com/roock/bareos_exporter/bareos_exporter bareos_exporter
